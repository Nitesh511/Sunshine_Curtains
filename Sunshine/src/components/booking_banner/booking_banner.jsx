...
const BookingBanner = ({
  ...
  return (
    <div className="flex flex-col md:flex-row relative overflow-hidden p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex-1 flex items-center justify-center bg-black bg-opacity-50 p-4 sm:p-6 md:p-8 lg:p-10 text-white">
        <div className="text-center md:text-left max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl">
          ...
          <a
            href={buttonLink}
            className=" bg-customColorRgb hover:bg-yellow-600 text-white font-bold py-2 px-4 sm:py-2.5 sm:px-5 md:py-3 md:px-6 lg:py-3.5 lg:px-7 rounded-lg transition duration-300"
          >
            {buttonText}
          </a>
        </div>
